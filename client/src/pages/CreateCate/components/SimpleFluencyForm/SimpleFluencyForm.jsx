...
export default class SimpleFluencyForm extends Component {
  ...
  handleSubmit = () => {
    ...
    this.form.validateAll((errors, values) => {
      ...
      dispatch({type:'cate/createCate',payload:{postBody:values}})
          ...
          >
            <div className={styles.formContent}>
              ...
              <Row className={styles.formRow}>
                ...
                <Col xxs="16" s="10" l="6">
                  <FormBinder name="cateName" required message="必填项">
                    <Input />
                  </FormBinder>
                  <div className={styles.formErrorWrapper}>
                    <FormError name="cateName" />
                  </div>
                </Col>
              </Row>
              <Row className={styles.formRow}>
                ...
                <Col xxs="16" s="10" l="6">
                  <FormBinder name="cateShortName" required message="必填项">
                    <Input />
                  </FormBinder>
                  <div className={styles.formErrorWrapper}>
                    <FormError name="cateShortName" />
                  </div>
                </Col>
              </Row>
              <Row>
